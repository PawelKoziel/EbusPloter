...
function drawChart(data) {
  ...
  // var yHwcScale = d3
  //   .scaleLinear()
  //   .domain([0, d3.max(data, d => d.HwcUsage)])
  ...
  let hcUsageBars =
    chart.selectAll("mybar")
      ...
      .attr("y", d => yHcScale(d.HcUsage))
      .attr("width", xScale.bandwidth())
      .attr("height", (d) => drawSize.height - yHcScale(d.HcUsage))
      .attr("fill", colorHc)
      .attr("opacity", 0.6)
  ...
  let hwcUsageBars =
    chart.selectAll("mybar")
      ...
      .append("rect")
      .attr("x", d => xScale(d.date))
      .attr("y", d => yHcScale(d.HwcUsage))
      .attr("width", xScale.bandwidth())
      .attr("height", (d) => drawSize.height - yHcScale(d.HwcUsage))
      .attr("fill", colorHwc)
      .attr("opacity", 0.6)
  ...
  // Legend
  chart.append("circle").attr("cx", margin.left).attr("cy", 30).attr("r", 6).style("fill", colorHc)
  chart.append("circle").attr("cx", margin.left).attr("cy", 50).attr("r", 6).style("fill", colorHwc)
  chart.append("text").attr("x", margin.left + 10).attr("y", 35).text("ogrzewanie").style("font-size", "15px").attr("alignment-baseline", "middle")
  chart.append("text").attr("x", margin.left + 10).attr("y", 55).text("woda w kranie").style("font-size", "15px").attr("alignment-baseline", "middle")
  ...
  function zoomed(event) {
    ...
    hcUsageBars.attr("width", d => xz(d.date))
    hwcUsageBars.attr("width", d => xz(d.date))
